...
public:
    ...
    virtual ::grpc::Status TransactionPrepare(::grpc::ServerContext* context, const ::Bicache::TransactionStepRequest* request, ::Bicache::TransactionStepReply* response)override;
    virtual ::grpc::Status TransactionCommit(::grpc::ServerContext* context, const ::Bicache::TransactionStepRequest* request, ::Bicache::TransactionStepReply* response)override;
    virtual ::grpc::Status TransactionRollback(::grpc::ServerContext* context, const ::Bicache::TransactionStepRequest* request, ::Bicache::TransactionStepReply* response)override;
